...
<html lang="ko">
	<head>
		...
		<style>
			...
			#drawingWrite .coord { width: 780px; margin-top: 15px; padding: 10px; font-size: 9px; background-color: #f8f8f8; color: #999; }
		</style>
...
//                 },
				...
				moveBox : function(direction) {
					...
					var canvas = that.data.canvas; 
					var step = 1;
					var activeBox = canvas.getActiveObject();
					
					
					switch(direction){
						case "left":
							activeBox.left = activeBox.left - step;
							break;
						case "up":
							activeBox.top = activeBox.top - step;
							break;
						case "right":
							activeBox.left = activeBox.left + step;
							break;
                ...
                zoomIn : function() {
                    ...
                    canvas.setZoom(canvas.getZoom() * scaleFactor);
